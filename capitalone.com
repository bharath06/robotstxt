...
Disallow: /cars/docs/fax-cover-sheet.pdf
Disallow: /landing?*
Disallow: /landing?PFFSRCID*
...
User-agent: YandexImageResizer/2.0
User-agent: YandexImages/3.0
User-agent: YandexMedia/3.0
User-agent: YandexPagechecker/1.0
User-agent: YandexWebmaster/2.0
User-agent: YandexZakladki/3.0
Disallow: /assets/bank/media/beneficiary-form.pdf
Disallow: /cars/docs/fax-cover-sheet.pdf
Disallow: /landing?*
Disallow: /landing?PFFSRCID*
